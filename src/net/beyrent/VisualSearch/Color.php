...
namespace net\beyrent\VisualSearch;
...
/**
 * Class Color
 * @package net\beyrent\VisualSearch
 */
class Color {
  ...
  /**
   * Sets the input and output handling.
   *
   * @param enum $from
   *   one of INT, HEX, RGB, HSL, HSV
   * @param enum $to
   *   one of INT, HEX, RGB, HSL, HSV
   *
   * @return Color
